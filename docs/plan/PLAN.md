...
2. Select a source for BTC price data.
    - 2.1. Use AI or manual search to identify 3 potential data sources providing BTC daily price up to the present date. (IP)
    - 2.2. Evaluate these sources to determine ease of integration.
    - 2.3. Choose the best data source and obtain the data via API or CSV download to the data folder.
3. Explore and visualize the time series data to identify noise, trend, seasonal, and cyclical components. 
